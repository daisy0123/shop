    ...
    <div class="container goods-list">
        <div class="container">      
            <?php if(is_array($goodslist)): $i = 0; $__LIST__ = $goodslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="col-sm-4 col-md-3">
                    <a href="<?php echo U('User/items/goodsid/'.$data['goodsid']);?>">
                        <div class="thumbnail">
                            <img src="<?php echo ($data['goodsimg00']); ?>" alt="">
                            <div class="caption goods_intro">
                                <a href="<?php echo U('User/items/goodsid/'.$data['goodsid']);?>" class="goods_name"><?php echo ($data['goodsname']); ?></a>
                                ...
                                <p class="text-right"><a href="<?php echo U('User/items/goodsid/'.$data['goodsid']);?>" class="btn btn-primary goods_buy" role="button">立即购买</a></p>
                            </div>
                        </div>
                    </a>               
