...
<html>
    ...
    <div class="col-md-6 col-md-offset-3">                        
        <div class="col-md-2"><button type="button" class="btn btn-default" id="first-part">买家增加</button></div>
        <div class="col-md-2"><button type="button" class="btn btn-default second-part" id="second-part">买家增加</button></div>
        <div class="col-md-2"><button type="button" class="btn btn-default third-part" id="third-part">商品增加</button></div>
        <div class="col-md-2"><a href="<?php echo U('Index/admin');?>"><button type="button" class="btn btn-default third-part">回到管理页面</button></a></div>
    </div>
</div>
<div class="row part-page">
    <div class="first-part-page">
        <form class="col-md-offset-3 form-horizontal" enctype='multipart/form-data' role="form" method="post" action="<?php echo U('Index/doAdminAdd');?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="eamil" class="form-control" id="email" name="email" value="">
                </div>
            </div>
            <div class="form-group">
    ...
    <div class="third-part-page">
        <form class="col-md-offset-3 form-horizontal" enctype='multipart/form-data' role="form" method="post" action="<?php echo U('Index/doAdminAdd');?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="goodsintro" name="goodsintro" value="">
                </div>
            </div>
            <div class="form-group">
                <label for="goodssize" class="col-sm-2 control-label">商品规格</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="goodssize" name="goodssize" value="">
                </div>
            </div>
            <div class="form-group">
                <label for="goodsprice" class="col-sm-2 control-label">商品价格</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="goodsprice" name="goodsprice" value="">
                </div>
            </div>
            <div class="form-group">
                <label for="goodscount" class="col-sm-2 control-label">商品数量</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="goodscount" name="goodscount" value="">
                </div>
            </div>
            <div class="form-group">
                <label for="goodssend" class="col-sm-2 control-label">商品运费</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="goodssend" name="goodssend" value="">
                </div>
            </div>                 
            <div class="form-group">
                <div class="col-sm-offset-4 col-sm-8">
